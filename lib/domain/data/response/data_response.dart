...
class Data {
  ...
  final List<DataBundle> dataBundle;

  Data({required this.dataBundle, this.serviceId});

  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
        serviceId: json['service_id'],
        dataBundle: (json['data_bundle'] as List<dynamic>? ?? [])
            .map((e) => DataBundle.fromJson(e))
            .toList(),
    );
  }
  ...
  Map<String, dynamic> toJson() => {
    'serviceId': serviceId,
    'data_bundle': dataBundle.map((e) => e.toJson()).toList(),
  };
}

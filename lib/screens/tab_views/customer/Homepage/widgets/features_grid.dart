...
//               userState is GetUserSuccessful && userState.user.meter?.status != 2
//                   ? const MeterDisconnectedBanner()
...
//             borderRadius: BorderRadius.circular(12),
//             border: Border.all(
//               color: active ? MoColors.borderIdle : MoColors.borderIdle.withOpacity(0.5),
//               width: 1,
//             ),
//           ),
...
//                 opacity: active ? 1.0 : 0.35,
//                 child: SizedBox(
//                   height: context.isTablet ? 80 : 36,
//                   width: context.isTablet ? 80 : 36,
//                   child: Image.asset(image, fit: BoxFit.contain),
//                 ),
//               ),
...
//                 overflow: TextOverflow.ellipsis,
//                 style: TextStyle(
//                   fontSize: context.isTablet ? 14.0 : 11,
//                   fontWeight: FontWeight.w600,
//                   color: active ? MoColors.textPrimary : MoColors.textHint,
//                 ),
//               ),
...
//                 overflow: TextOverflow.ellipsis,
//                 style: TextStyle(
//                   fontSize: context.isTablet ? 13.0 : 9,
//                   color: MoColors.textSecondary,
//                 ),
//               ),
//             ],
